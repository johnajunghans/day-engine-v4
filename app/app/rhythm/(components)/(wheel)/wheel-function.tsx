        ...
        <>
            <defs>
                ...
                <linearGradient id="violet-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor=" #2e1065" />
                    <stop offset="95%" stopColor="#391479" />
                    <stop offset="5%" stopColor="#44198d" />
                    <stop offset="95%" stopColor="#4f1da1" />
                    <stop offset="5%" stopColor="#5b21b6" />
                </linearGradient>
                <linearGradient id="indigo-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor="#1e1b4b" />
                    <stop offset="95%" stopColor="#242060" />
                    <stop offset="5%" stopColor="#2a2676" />
                    <stop offset="95%" stopColor="#302b8c" />
                    <stop offset="5%" stopColor="#3730a3" />
                </linearGradient>
                <linearGradient id="sky-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor="#082f49" />
                    <stop offset="95%" stopColor="#093957" />
                    <stop offset="5%" stopColor="#094366" />
                    <stop offset="95%" stopColor="#094e75" />
                    <stop offset="5%" stopColor="#075985" />
                </linearGradient>
                <linearGradient id="zinc-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor="#09090b" />
                    <stop offset="95%" stopColor="#131314" />
                    <stop offset="5%" stopColor="#1a1a1c" />
                    <stop offset="95%" stopColor="#202023" />
                    <stop offset="5%" stopColor="#27272a" />
                </linearGradient>
                <linearGradient id="emerald-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor="#022c22" />
                    <stop offset="95%" stopColor="#02382b" />
                    <stop offset="5%" stopColor="#024534" />
                    <stop offset="95%" stopColor="#03523d" />
                    <stop offset="5%" stopColor="#065f46" />
                </linearGradient>
                <linearGradient id="amber-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor="#451a03" />
                    <stop offset="95%" stopColor="#572309" />
                    <stop offset="5%" stopColor="#6a2c0c" />
                    <stop offset="95%" stopColor="#7e360d" />
                    <stop offset="5%" stopColor="#92400e" />
                </linearGradient>
                <linearGradient id="slate-gradient" gradientTransform="rotate(90)">
                    <stop offset="5%" stopColor="#020617" />
                    <stop offset="95%" stopColor="#0d121f" />
                    <stop offset="5%" stopColor="#131a28" />
                    <stop offset="95%" stopColor="#182131" />
